...
describe('Certification Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'certification', component: CertificationComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to certificationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCertificationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCertificationIdentifier).toHaveBeenCalledWith(entity);
