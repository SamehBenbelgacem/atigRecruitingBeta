...
import { EntityArrayResponseType, CertificationService } from '../service/certification.service';
...
export class CertificationComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICertification): number => this.certificationService.getCertificationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.certifications = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICertification[] | null): ICertification[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.certificationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
