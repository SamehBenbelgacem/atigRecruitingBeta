...
type EventFormGroupContent = {
  ...
  externalParticipants: FormControl<EventFormRawValue['externalParticipants']>;
  date: FormControl<EventFormRawValue['date']>;
  duration: FormControl<EventFormRawValue['duration']>;
  description: FormControl<EventFormRawValue['description']>;
  priority: FormControl<EventFormRawValue['priority']>;
  user: FormControl<EventFormRawValue['user']>;
};
...
export class EventFormService {
  createEventFormGroup(event: EventFormGroupInput = { id: null }): EventFormGroup {
    ...
    return new FormGroup<EventFormGroupContent>({
      ...
      externalParticipants: new FormControl(eventRawValue.externalParticipants),
      date: new FormControl(eventRawValue.date),
      duration: new FormControl(eventRawValue.duration),
      description: new FormControl(eventRawValue.description),
      priority: new FormControl(eventRawValue.priority),
      user: new FormControl(eventRawValue.user),
    });
  }
