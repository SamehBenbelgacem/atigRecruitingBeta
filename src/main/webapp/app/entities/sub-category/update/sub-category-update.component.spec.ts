...
describe('SubCategory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Category query and add missing value', () => {
      ...
      const subCategoryCategory: ICategory = { id: 17959 };
      subCategory.subCategoryCategory = subCategoryCategory;
      const category: ICategory = { id: 19952 };
      subCategory.category = category;

      const categoryCollection: ICategory[] = [{ id: 28908 }];
      jest.spyOn(categoryService, 'query').mockReturnValue(of(new HttpResponse({ body: categoryCollection })));
      const additionalCategories = [subCategoryCategory, category];
    ...
    it('Should update editForm', () => {
      const subCategory: ISubCategory = { id: 456 };
      const subCategoryCategory: ICategory = { id: 8534 };
      subCategory.subCategoryCategory = subCategoryCategory;
      const category: ICategory = { id: 4304 };
      subCategory.category = category;

      activatedRoute.data = of({ subCategory });
      comp.ngOnInit();

      expect(comp.categoriesSharedCollection).toContain(subCategoryCategory);
