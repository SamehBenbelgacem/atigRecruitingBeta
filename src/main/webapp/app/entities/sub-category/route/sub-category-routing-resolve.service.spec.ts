...
import subCategoryResolve from './sub-category-routing-resolve.service';

describe('SubCategory routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: SubCategoryService;
  let resultSubCategory: ISubCategory | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ISubCategory returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        subCategoryResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSubCategory).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISubCategory>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
