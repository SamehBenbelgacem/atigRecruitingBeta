...
import { EntityArrayResponseType, ToolService } from '../service/tool.service';
...
export class ToolComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITool): number => this.toolService.getToolIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.tools = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITool[] | null): ITool[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.toolService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
