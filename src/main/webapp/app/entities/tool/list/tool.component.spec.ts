...
describe('Tool Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tool', component: ToolComponent }]), HttpClientTestingModule, ToolComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to toolService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getToolIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getToolIdentifier).toHaveBeenCalledWith(entity);
