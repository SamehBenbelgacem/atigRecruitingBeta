...
import atig.recruiting.beta.repository.CategoryRepository;
import atig.recruiting.beta.service.dto.CategoryDTO;
import atig.recruiting.beta.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().title(DEFAULT_TITLE);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().title(UPDATED_TITLE);
        return category;
    }
    ...
    @Test
    @Transactional
    void getAllCategoriesByCandidatesIsEqualToSomething() throws Exception {
        ...
        em.flush();
        category.addCandidates(candidates);
        categoryRepository.saveAndFlush(category);
        Long candidatesId = candidates.getId();
        // Get all the categoryList where candidates equals to candidatesId
        defaultCategoryShouldBeFound("candidatesId.equals=" + candidatesId);

        // Get all the categoryList where candidates equals to (candidatesId + 1)
        defaultCategoryShouldNotBeFound("candidatesId.equals=" + (candidatesId + 1));
    }

    @Test
    @Transactional
    void getAllCategoriesByCompaniesIsEqualToSomething() throws Exception {
        Company companies;
        ...
        em.flush();
        category.addCompanies(companies);
        categoryRepository.saveAndFlush(category);
        Long companiesId = companies.getId();
        // Get all the categoryList where companies equals to companiesId
        defaultCategoryShouldBeFound("companiesId.equals=" + companiesId);

        // Get all the categoryList where companies equals to (companiesId + 1)
        defaultCategoryShouldNotBeFound("companiesId.equals=" + (companiesId + 1));
    }
